/**
 * *****************************************************************************
 * Copyright (c) 2008, 2012 Obeo. All rights reserved. This program and the
...
import com.sofrecom.codegen.impl.CodegenFactoryImpl;
import java.io.File;
...
public class Main extends AbstractAcceleoGenerator {
     ...
     * @generated
     */
    public static final String MODULE_FILE_NAME = "/com/tmp/acceleo/ui/Main";
    /**
     ...
     * generation : it will be the base path against which all file block URLs
     * will be resolved.
     * @param arguments If the template which will be called requires more than
     * one argument taken from the model, pass them here.
     * @throws IOException This can be thrown in three scenarios : the module
     * cannot be found, it cannot be loaded, or the model cannot be loaded.
     * @generated
     */
     ...
     * Objects matching the first parameter of the template we need to call.
     * @param targetFolder This will be used as the output folder for this
     * generation : it will be the base path against which all file block URLs
     * will be resolved.
     * @param arguments If the template which will be called requires more than
     * one argument taken from the model, pass them here.
     * @throws IOException This can be thrown in two scenarios : the module
     * cannot be found, or it cannot be loaded. @generated
     */
     ...
     *
     * @param args Arguments of the generation. @generated
     */
     ...
     *
     * @param monitor This will be used to display progress information to the
     * user.
     * @throws IOException This will be thrown if any of the output files cannot
     * be saved to disk. @generated
     */
    @Override
     ...
     * <b>Note</b>, however, that this <b>cannot</b> be used standalone. </p>
     * <p>
     * All three of these default strategies support merging through JMerge.
     * </p>
     *
     * @return The generation strategy that is to be used for generations
     * launched through this launcher. @generated
     */
    @Override
     ...
     *
     * @return The name of the module that is to be launched. @generated
     */
    @Override
     ...
     *
     * @param propertiesFile The properties file to add. @generated
     * @since 3.1
     */
    @Override
