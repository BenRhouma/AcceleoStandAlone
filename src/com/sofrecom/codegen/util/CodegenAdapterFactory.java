...
public class CodegenAdapterFactory extends AdapterFactoryImpl {
	...
	protected CodegenSwitch<Adapter> modelSwitch =
		new CodegenSwitch<Adapter>() {
			...
			@Override
			public Adapter caseUIHints(UIHints object) {
				return createUIHintsAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link com.sofrecom.codegen.Entity <em>Entity</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link com.sofrecom.codegen.Attribute <em>Attribute</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link com.sofrecom.codegen.UIHints <em>UI Hints</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createUIHintsAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link com.sofrecom.codegen.ViewModel <em>View Model</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
